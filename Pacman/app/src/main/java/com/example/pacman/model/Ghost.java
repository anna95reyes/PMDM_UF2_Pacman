...
public class Ghost extends Sprite {
    ...
    private MovimentJoystick mMove = new MovimentJoystick(1, 0);
    ...
    private MovimentJoystick recalculaDireccio() {
